...
import {
        Layer, LayerService, Marker, IMarkerIconInfo, IMarkerOptions, ClusterClickAction, ClusterPlacementMode,
        IClusterOptions, ILayerOptions, ILatLong, IPoint, MarkerService, ClusterService, MapService, IMarkerEvent, ClusterLayerDirective } from 'angular-maps';
import { IClusterIconInfo } from 'angular-maps/src/interfaces/icluster-icon-info';
...
@Directive({
    selector: 'my-map-layer'
})
export class MyMapLayerDirective implements OnDestroy, OnChanges, AfterContentInit {
